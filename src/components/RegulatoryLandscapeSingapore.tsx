  ...
  return (
    <div>
      ...
      <section className="ed-section">
        <p className="ed-section-label">Intro Definition</p>
        <h2 className="ed-h2">
      ...
      <section className="ed-section">
        <p className="ed-section-label">Classification Context</p>
        <h2 className="ed-h2">
      ...
      <section className="ed-section">
        <p className="ed-section-label">Labelling Expectations</p>
        <h2 className="ed-h2">Label Components and Disclosure Requirements</h2>
        <p className="ed-p">
        ...
        <table className="ed-table">
          ...
          <tbody>
            <tr>
              <td><strong>Ingredient listing</strong></td>
              <td>
            ...
            <tr>
              <td><strong>Importer information</strong></td>
              <td>
        ...
        <p className="ed-p" style={{ marginTop: "16px" }}>
      ...
      <section className="ed-section">
        <p className="ed-section-label">Online Sales Context</p>
        <h2 className="ed-h2">
